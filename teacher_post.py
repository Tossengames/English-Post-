...
def generate_teacher_post(teacher_id: str, lesson_content: str, teacher_info: dict) -> str:
    ...
    **في بداية المنشور، قم بإنشاء عنوان واضح ومباشر يحدد مستوى الدرس. يجب أن يكون العنوان على النحو التالي: 'درس اليوم: [مستوى الدرس باللغة العربية]'. على سبيل المثال: 'درس اليوم: مستوى مبتدئ' أو 'درس اليوم: مستوى متقدم'.**
