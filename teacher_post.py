...
CTAS = [
    "💬 شاركنا إجابتك في التعليقات! ولا تنسى الإعجاب بالمنشور ومشاركته مع أصدقائك",
    "🌟 هل وجدت هذه المعلومات مفيدة؟ اضغط زر الإعجاب وشاركها مع زملائك",
    "🤝 ساعد غيرك في التعلم بمشاركة هذا المنشور",
    "🎯 تابعنا للمزيد من الدروس المفيدة يومياً",
    "📌 حفظت هذه القاعدة؟ أظهر لنا ذلك بلايك وتعليق",
...
def generate_lesson_post():
    ...
    4. أمثلة قصيرة (الإنجليزية مع الترجمة والنطق المكتوب بالحروف العربية فقط)
    5. أضف في نهاية المنشور:
       - "{random.choice(CTAS)}"
       - "🔔 تابع الصفحة لتصلك جميع الدروس الجديدة"
       - "📢 انضم لقناتنا على تلغرام لدروس متقدمة: https://t.me/alleliteenglish"
    6. أنهِ المنشور بهذه الهاشتاقات بالضبط: {style['hashtags']}
    
    ملاحظات:
    - المحتوى قصير (3-5 أسطر كحد أقصى) وسهل القراءة
    - النطق بالحروف العربية فقط (مثال: "إيت ذا بوي")
    - استخدم لغة تشجيعية تحفز التفاعل
    - أضف سؤالاً تشويقياً في النهاية
    - استخدم 3-5 إيموجي في المنشور
    - ركز على فائدة واحدة رئيسية
    """
