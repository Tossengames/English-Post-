...
def get_random_general_prompt():
    ...
    prompts = [
        ...
        "اكتبي معلومة ثقافية صغيرة أو ممتعة عن دولة ناطقة بالإنجليزية، بالإنجليزية ثم ترجمتها للعربية. لا تذكري مصدرها أو أنها طلبية.","Write a post about a word of the day in Arabic,  don't mention AI or anything","give grammar tip in Arabic"
    ]
